        ...
        content={
            <div>
                ...
                <p>
                    ...
                    <p />
    <p>La musique d'ensemble est placée sous la coordination pédagogique de <InnerLink to="/fr/josep-cabre">
    Josep Cabré</InnerLink>avec qui les stagiaires préparent une pièce collective (la pièce sera déterminée en fonction 
    des tessitures des chanteurs acceptés dans l'Académie 2019. En 2018, les chanteurs avaient préparé Jephté de Carissimi.
     </p>
                     <p>La journée se conclut sous la forme d'une masterclasse qui sera consacrée aux
                ...
                <List>
                    <ListItem>
                        ...
                        préparent un oratorio sous la forme d'un atelier journalier de 3
                        heures conduisant à une restitution publique à la fin du stage. Le choix de cet oratorio sera déterminé
