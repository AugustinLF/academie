    ...
    <InnerPage
        ...
        content={
            <div>
                ...
                <p>La première partie du programme choral, sous la direction de <InnerLink to="/fr/philippe-le-fevre">Philippe 
    Le Fèvre</InnerLink>, sera consacrée à des œuvres de Tomas Luis de Victoria (1548-1611). Victoria est certainement l’un des
    plus grands compositeurs espagnols et un des plus importants compositeurs européens de la 
contre-réforme. Il passera près de 20 ans à Rome, d’abord pour sa formation, puis pour devenir prête. 
    Il succèdera à Palestrina comme maître de chapelle du Séminaire Romain. Victoria retournera à Madrid où il sera notamment maître de chapelle et 
organiste de deux impératrices.
    </p>
                <p>
La publication en 1585 à Rome d’un recueil contenant neuf lamentations, dix-huit répons des ténèbres et deux passions 
    couvrant ainsi toute la semaine sainte lui apporte immédiatement une large notoriété. 
 </p>
                <p>
Nous alternerons lamentations et répons, tel que cela se pratiquait dans les offices de ténèbres.
 </p>
                <p>
 <List>
<ListItem>7ème répons du jeudi saint : Eram quasi agnus</ListItem>
<ListItem>Lamentations du vendredi saint : Lamed. Matribus suis dixerunt</ListItem> 
...
<ListItem>9ème répons  du samedi saint : Sepulto Domino</ListItem>
                ...
                <p>
Avec <InnerLink to="/fr/adam-vidovic">Adam Vidovic</InnerLink> nous aborderons La tradition anglicane des vêpres chantés ou « choral Evensong ».
Célébrées en fin d’après-midi ou en début de soirée, la structure des vêpres reste quasi inchangée dans les 
cathédrales britanniques et chapelles des collèges universitaires d’Oxford et Cambridge depuis la dernière version du 
‘Book of Common Prayer’ (1662). Ces institutions continuent à perpétuer cette tradition aujourd’hui encore, et puisent 
dans un répertoire musical abondant des œuvres de grande qualité produites par les maîtres à travers les âges. Sans respecter un temps liturgique particulier, nous chanterons une sélection de ces œuvres nous permettant de s’immiscer dans ce service divin du soir en 'anthems', cantiques et réponses. 
 </p>
                <p>
<List>
...
<ListItem>Hymne - Rejoice the Lord is King Händel 
<ListItem>Bénédicton & Amen - Gibbons - Threefold Amen</ListItem>
                ...
                <p>
                    ...
                    <InnerLink to="/fr/stefano-intrieri">Stefano Intrieri</InnerLink>. Les répétitions reprennent à 16h30 jusqu’à 19h00, avec le chef avec lequel le
                ...
                <p>
                    ...
                    pas au déchiffrage ! Au début du mois de juillet, des séances de travail en pupitre
                    seront organisées. Les choristes habitant en région parisienne pourront s'y rendre physiquement,
                    les autres pourront y participer par video.
                </p>
            </div>
        }
    />
