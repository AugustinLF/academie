    ...
    <InnerPage
        ...
        content={
            <div>
                ...
                <p>
                    <InnerLink to="/fr/philippe-le-fevre">Philippe Le Fèvre</InnerLink>Philippe Le
                    Fèvre will direct the first part of the choral program, dedicated to works by
                    Tomas Luis de Victoria (1548-1611). Victoria is one of the greatest Spanish
                    composers and was one of the most prolific European composers of the
                    counter-reform. He spent nearly 20 years in Rome, where he studied, and prepared
                    for the priesthood. He succeeded Palestrina as chapel master of the Roman
                    Seminary. Victoria subsequently returned to Madrid to become the director of
                    music and organist of two empresses. Immediate renown followed the publication
                    in 1585 in Rome of a collection of nine lamentations, eighteen responses of
                    darkness and two passions, composed for Holy Week
                </p>
                <p>
                    <List>
                ...
                <p>
                    <InnerLink to="/en/adam-vidovic">Adam Vidovic</InnerLink> Adam Vidovic will work
                    on the Anglican tradition of choral Evensong. Sung in the late afternoon or
                    early evening, the service has remained virtually unchanged within British
                    cathedrals and the chapels of Oxford and Cambridge University, since the last
                    version of the Book of Common Prayer (1662). These institutions continue to
                    perpetuate this wonderful tradition today, and draw from a wealth of
                    high-quality choral (and organ) repertoire, composed throughout the ages.
                    Without respecting any particular liturgical season, we will sing a selection of
                    these works, including anthems, hymns and responses.
                </p>
                <p>
                    <List>
                        ...
                        <ListItem>
                            Hymn - George Frideric Händel - Sinners obey the Gospel Word
                        </ListItem>
