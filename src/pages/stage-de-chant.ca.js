...
const Vocal = () => (
    <InnerPage
        ...
        content={
            <div>
                Amb  <InnerLink to="/ca/maarten-koningsberger">Maarten Koningsberger</InnerLink> aquest taller associa tècnica vocal i interpretació de la música
                barroca. Els cantants dividiran el seu temps entre repertori solista, treball de
                protagonista i de música de conjunt. Cada dia començarà amb un curs col·lectiu sobre
