...
const Vocal = () => (
    <InnerPage
        ...
        content={
            <div>
                <p>Els inscrits participants triaran entre dues fòrmules:</p>
                <List>
                    <ListItem>
                        Amb Maarten Koningsberger aquest taller associa tècnica vocal i
                        ...
                        <p>
                            ...
                            <InnerLink to="/ca/maarten-koningsberger">
                    ...
                    <ListItem>
                        Amb <InnerLink to="/ca/josep-cabre">Josep Cabré</InnerLink> els participants
                        al curs treballarem sobre una de les històries sagrades - oratoris de
                        Marc-Antoine Charpentier. L’obra escollida ho serà en funció dels cantants
                        inscrits i/o seleccionats.
                        <p>
                            Es tractarà d’una d’aquestes dues obres:
                            <ul>
                                <NestedListItem>
                                    Marc-Antoine Charpentier: Sacrificium Abrahae
                                </NestedListItem>
                                <NestedListItem>
                        ...
                        <p>
                            Amb el treball de muntatge es parlarà tambe de diversos aspectes en
                            relació amb les obres: relació text-música, aproximació retòrica,
                            articulació i silenci expressiu, notes iguals o desiguals a partir dels
                            textos del mateix Charpentier, pronúncia del llatí: a la francesa?
                            italià eclesiàstic? alguna altra?…
                        </p>
                    </ListItem>
                </List>
            </div>
