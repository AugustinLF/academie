...
const Informations = () => (
    <Page title="Ce qu'il faut savoir">
        <LeadImage src={Barcelona} alt="house" />
        <Section title="L'hébergement">
            <div>
                <p>
                    L'Académie se déroule dans la "Casa Sant Felip Neri", un ancien couvent. Cours,
                    répétition, hébergement et restauration sont sur le même site. Situé dans le
                    quartier résidentiel calme de la Sarria, la Casa Sant Felip Neri est à 300
                    mètres du métro qui nous amène en 5 stations et 10 minutes à la place de
                ...
                <List>
                    ...
                    <ListItem>
                        Chambre triple avec lavabo dans la chambre (trois lits simples) et douches
                        et toilettes partagées avec d'autres chambres
                    </ListItem>
                    <ListItem>
                ...
                <p>
                    Le linge de toilette est fourni, les draps sont changés en milieu de séjour. Les
                    articles de toilette ne sont pas fournis.
                </p>
                <p>
                    Il est possible d'arriver plus tôt ou de repartir plus tard, des chambres sont
                    disponibles (sans repas) : nous consulter.
                </p>
                <p>
                    A noter : les murs épais du couvent garantissent une fraîcheur relative en été
                    dans les chambres. La grande salle de répétition est climatisée si nécessaire.
                    Le studio de danse est climatisé.
                </p>
            </div>
        </Section>
